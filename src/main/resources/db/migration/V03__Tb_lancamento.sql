...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) values ('Alimentação', '2019-06-10', null, 6500.00, 'Distribuição de lucros', 'RECEITA', 2, 1);
...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) values ('Supermercado', '2019-06-10', null, 200.30, null, 'DESPESA', 3, 2);
...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) values ('Estudo Financeiro', '2019-03-10', '2019-03-10', 400.32, null, 'DESPESA', 5, 1);
...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) values ('Farmácia', '2019-06-10', null, 1040.32, null, 'DESPESA', 4, 2);
